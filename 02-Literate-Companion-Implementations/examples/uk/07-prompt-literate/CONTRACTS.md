...
- **Allowed changes:** None unless plan is explicitly revised first.
- **Forbidden changes:** Reordering architecture, changing `main()`, adding external dependencies.
- **Acceptance criteria:** Preserved exactly as in plan.
...
- **Role:** Generate exactly first 1000 primes according to declared interfaces.
- **Status:** LLM-fillable.
...
- **Forbidden changes:** Changing declarations, constants, chunk names, architecture, dependencies.
- **Acceptance criteria:**
  - Starts from prime `2`.
...
- **Forbidden changes:** Header format changes, layout constant reinterpretation, signature change.
- **Acceptance criteria:**
  ...
  - Output includes prime `7919` in printed result.
